...
const PatientEditProfile = () => {
    ...
    const[formdata,setFormdata]=useState({emailId:auth.user.emailId,oldPassword:"",newPassword:"",confirmNewPassword:"",name:auth.user.name,username:auth.user.username,address:auth.user.address,phoneNumber:auth.user.phoneNumber, birthdate:auth.user.birthdate, gender:auth.user.gender});
    ...
    const submitHandler = async (event) => {
        ...
        try{   
            ...
            const res = await axios.put(`${process.env.REACT_APP_API}/api/v1/patient/update-profile`, {name:formdata.name, oldPassword: formdata.oldPassword, newPassword:formdata.newPassword, confirmNewPassword: formdata.confirmNewPassword, phoneNumber:(formdata.phoneNumber).toString(), address:formdata.address, birthdate:formdata.birthdate, gender:formdata.gender});
        ...
        <Layout title="MedTech - Edit Profile">
            ...
            <div className="mb-auto">
                ...
                <div className="flex flex-col mt-8  ">
                    ...
                    <pre className="text-xl font-extrabold mt-4 ml-24">Update Patient Profile</pre>
